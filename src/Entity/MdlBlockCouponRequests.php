...
/**
 * MdlBlockCouponRequests
 *
 * @ORM\Table(name="mdl_block_coupon_requests", indexes={@ORM\Index(name="mo_bloccouprequ_use_ix", columns={"userid"})})
 * @ORM\Entity
 */
class MdlBlockCouponRequests
{
    /**
     * @var int
     *
