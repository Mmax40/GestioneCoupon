...
/**
 * MdlCompetencyUserevidence
 *
 * @ORM\Table(name="mdl_competency_userevidence", indexes={@ORM\Index(name="mo_compuser_use_ix", columns={"userid"})})
 * @ORM\Entity
 */
class MdlCompetencyUserevidence
{
    /**
     * @var int
     *
